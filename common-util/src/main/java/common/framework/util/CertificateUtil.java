...
public class CertificateUtil {
     ...
     * @throws Exception
     */
    public static void createX509SubjectCertFile(AZ_MyCertificateInfo certificateInfo,X509Certificate[] appendChain,String subjectPfxPath,String subjectPassword,String subjectCrtPath)throws Exception {
     ...
     * @throws Exception
     */
    public static X509Certificate newX509SubjectCert(AZ_MyCertificateInfo certificateInfo)throws Exception {
        Assert.notNull(certificateInfo,"certificateUtil_certificateInfo_null");
     ...
     * @throws Exception
     */
    public static void createX509RootCert(String alias,AZ_MyX500Name rootX500Name,String rootPfxPath, String rootCrtPath,String rootPassword) throws Exception{
     ...
     * @throws Exception
     */
    public static void createX509RootCertFile(AZ_MyCertificateInfo certificateInfo,String rootPfxPath,String rootPassword, String rootCrtPath) throws Exception{
        Assert.notNull(certificateInfo,"certificateUtil_certificateInfo_null");
    ...
    public static X509Certificate newX509RootCert(AZ_MyCertificateInfo certificateInfo) throws Exception{
        Assert.notNull(certificateInfo,"certificateUtil_certificateInfo_null");
        Assert.notNull(certificateInfo.getSubjectName(),"certificateUtil_subjectName_null");
        Assert.notNull(certificateInfo.getStartTime(),"certificateUtil_startTime_null");
        Assert.notNull(certificateInfo.getEndTime(),"certificateUtil_endTime_null");
    ...
    public static X509CertInfo produceX509CertInfo(Date startDate,Date endDate,AZ_MyX500Name rootX500Name,AZ_MyX500Name subjectX500Name,String sigAlg,PublicKey publicKey) throws Exception{
    ...
    public static X509CertInfo convert2X509CertInfo(AZ_MyCertificateInfo certificateInfo) throws Exception{
        Assert.notNull(certificateInfo,"certificateUtil_certificateInfo_null");
     ...
     * @return
     */
    public static boolean verifyCertificateChain(X509Certificate rootX509certificate,Collection<X509Certificate> chainX509Certificate, X509CRL x509crl,AZ_MyX500Name communicationTarget) throws Exception {
    ...
    public static CertAndKeyGen newCertAndKeyGen(String publicSigAlg,String signatureSigAlg) throws Exception{
        if (publicSigAlg == null || "".equals(publicSigAlg)) {
            publicSigAlg = "RSA";
        }
        if (signatureSigAlg == null || "".equals(signatureSigAlg)) {
            signatureSigAlg = "MD5WithRSA";
        }
