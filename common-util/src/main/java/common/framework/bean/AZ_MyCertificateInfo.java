...
import common.framework.util.TimeUtil;
 ...
 * @author Fuzhong.Yan
 */
public class AZ_MyCertificateInfo {
    ...
    private AZ_MyX500Name issuerName = new AZ_MyX500Name("");
    private PublicKey issuerPublicKey;
    private PrivateKey issuerPrivateKey;

    private AZ_MyX500Name subjectName = new AZ_MyX500Name("");
    ...
    public AZ_MyX500Name getIssuerName() {
        return issuerName;
    }

    public void setIssuerName(AZ_MyX500Name issuerName) {
        this.issuerName = issuerName;
    }

    public AZ_MyX500Name getSubjectName() {
        return subjectName;
    }

    public void setSubjectName(AZ_MyX500Name subjectName) {
