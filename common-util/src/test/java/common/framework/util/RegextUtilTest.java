...
import common.framework.bean.regex.AZ_DoubleRegexBean;
...
public class RegextUtilTest {
    ...
    public void test(){
        ...
        System.out.println(new AZ_DoubleRegexBean());
        List<String> res = RegextUtil.findGroup(new AZ_DoubleRegexBean(), test);
        for (String string : res) {
            System.out.println(string);
            System.out.println(RegextUtil.match(new AZ_DoubleRegexBean(), string));
        }
    }
}